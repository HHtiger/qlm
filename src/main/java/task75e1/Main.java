...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(FileType.getFileType(res));
        String type = FileType.getFileType(res);
        String fileName_target = "src/main/java/task75e1/tmp/res." + type;
